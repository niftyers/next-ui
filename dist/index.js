...
var NHLoader = ({ className, isText, iconClassName }) => {
  return /* @__PURE__ */ React.createElement("div", { className: CM("absolute flex items-center justify-center w-full h-full", className) }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-col items-center " }, /* @__PURE__ */ React.createElement(Loader, { className: CM("inline size-6 animate-spin", iconClassName) }), isText && /* @__PURE__ */ React.createElement("div", { className: "mt-2 text-xs" }, "Please wait a moment")));
};
...
var NHButton = ({
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { className: "relative flex items-center select-none hover:cursor-pointer" }, iconStart && /* @__PURE__ */ React.createElement("div", { className: "flex items-center" }, iconStart), caption && caption, iconEnd && /* @__PURE__ */ React.createElement("div", { className: "flex items-center" }, iconEnd)),
    isLoading && /* @__PURE__ */ React.createElement(NHLoader, { iconClassName: "size-4" })
  );
};
var NHButtonLink = ({
  theme = "default",
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    iconStart && /* @__PURE__ */ React.createElement("div", { className: "flex items-center" }, iconStart),
    caption && caption,
    iconEnd && /* @__PURE__ */ React.createElement("div", { className: "flex items-center" }, iconEnd),
    isLoading && /* @__PURE__ */ React.createElement(NHLoader, null)
  );
};
...
var NHIcon = ({ icon, ...props }) => {
  const IconRender = Icons[icon];
  if (!IconRender) {
    console.warn(`Icon "${icon}" not found`);
    return null;
  }
  return /* @__PURE__ */ React.createElement(IconRender, { ...props });
};
export {
  CM,
  NHButton,
