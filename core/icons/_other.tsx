...
import { IHtmlSvg } from "@/common";

export const IconNotFound: React.FC<IHtmlSvg> = (props) => {
  return (
    <svg viewBox="0 0 800 480" fill="currentColor" {...props}>
      <path
        id="cloud"
        className="st0"
